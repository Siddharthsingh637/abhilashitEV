    ...
    <section className="w-full py-12 sm:py-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          {/* Main bar */}
          <div className="relative overflow-hidden rounded-2xl sm:rounded-[36px] px-4 py-8 sm:px-6 sm:py-10 md:px-16 md:py-14 shadow-2xl flex flex-col items-center justify-center text-center text-emerald-50">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{
                backgroundImage: `url('https://ik.imagekit.io/siddharth637/abhilashit/engin-akyurt-HEMIBJ8QQuA-unsplash%20(2).jpg?updatedAt=1783420380154')`,
              }}
            />
